  ...
  public: {
    Tables: {
      ...
      voice_coaching_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "voice_coaching_sessions_pitch_deck_id_fkey"
            columns: ["pitch_deck_id"]
            isOneToOne: false
            referencedRelation: "deck_version_comparison"
            referencedColumns: ["current_deck_id"]
          ...
          {
            foreignKeyName: "voice_coaching_sessions_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "founders"
            referencedColumns: ["id"]
      ...
      voice_feedback: {
        Row: {
          created_at: string
          delivery_quality_feedback: string | null
          delivery_quality_score: number | null
          financial_logic_feedback: string | null
          financial_logic_score: number | null
          id: string
          impact_clarity_feedback: string | null
          impact_clarity_score: number | null
          improvements: string[] | null
          overall_score: number | null
          project_id: string | null
          recommendations: string[] | null
          sdg_alignment_feedback: string | null
          sdg_alignment_score: number | null
          session_id: string
          strengths: string[] | null
          user_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "voice_feedback_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "deck_version_comparison"
            referencedColumns: ["current_deck_id"]
          ...
          {
            foreignKeyName: "voice_feedback_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
    ...
    Views: {
      ...
      founder_watchlist_with_investors: {
        Row: {
          added_at: string | null
          founder_id: string | null
      ...
      founder_watchlist_with_projects: {
        Row: {
          added_at: string | null
          founder_id: string | null
          last_viewed_at: string | null
      ...
      investor_watchlist_with_projects: {
        Row: {
          added_at: string | null
          founder_data: Json | null
          founder_id: string | null
          investor_id: string | null
          last_viewed_at: string | null
          notes: string | null
      ...
      voice_session_stats: {
        Row: {
          ...
          discovery_sessions: number | null
          full_listen_sessions: number | null
          interrupt_sessions: number | null
          investor_sim_sessions: number | null
          last_session_date: string | null
          pitch_practice_sessions: number | null
    ...
    Functions: {
      ...
      get_voice_coaching_progress: {
        Args: { p_session_type?: string; p_user_id: string }
        Returns: {
          avg_score: number
