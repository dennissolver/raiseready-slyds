...
function ConfirmThesisContent() {
  ...
  const handleConfirm = async () => {
    ...
    if (response.ok) {
      router.push('/slyds/dashboard?thesis=confirmed')
    }
  }
      ...
      <div className="min-h-screen flex items-center justify-center">
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <Button onClick={() => router.push('/slyds/discovery')}>
              Start Discovery
            </Button>
          </CardContent>
        </Card>
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <Card className="border-2 border-primary">
          <CardHeader className="bg-gradient-to-r from-primary to-purple-700 text-white rounded-t-lg">
            <CardTitle>Review Your SlydS Thesis</CardTitle>
          ...
          <CardContent className="space-y-6 pt-6">
            ...
            <div className="flex gap-3 pt-4 border-t">
              ...
              <Button variant="outline" onClick={() => router.push('/slyds/discovery')} className="gap-2">
