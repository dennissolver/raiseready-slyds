    ...
    <div className="flex flex-col h-full bg-white border-r">
      ...
      <div className="p-6 border-b">
        <Link href="/founder/dashboard" className="flex items-center gap-2">
          ...
          <span className="font-bold text-xl bg-gradient-to-r from-primary to-purple-700 bg-clip-text text-transparent">
            SlydS
          </span>
        </Link>
      ...
      {/* Promo Box */}
      <div className="p-4">
        <div className="bg-gradient-to-br from-primary/10 to-purple-100 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            <BookOpen className="w-5 h-5 text-primary" />
            <span className="font-semibold text-sm">Storytelling Tips</span>
          </div>
          <p className="text-xs text-muted-foreground mb-3">
            Learn the Slyds method for crafting compelling narratives
          </p>
